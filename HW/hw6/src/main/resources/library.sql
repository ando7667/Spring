...
-- Дамп данных таблицы library.book_seq: ~1 rows (приблизительно)
...
-- Дамп данных таблицы library.issues_seq: ~1 rows (приблизительно)
...
-- Дамп данных таблицы library.readers_seq: ~1 rows (приблизительно)
