 ...
 * 		из метода значение по умолчанию (null, 0, false, ...). При этом, если тип исключения входит в список перечисленных
 * 		в noRecoverFor исключений, то исключение НЕ прерывается и прокидывается выше.
...
public class AppTimer {
	...
	public static void main(String[] args) {
		...
		ConfigurableApplicationContext context = SpringApplication.run(AppTimer.class, args);
